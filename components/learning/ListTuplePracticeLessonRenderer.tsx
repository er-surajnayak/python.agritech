...
export function ListTuplePracticeLessonRenderer({
  lesson,
  courseLesson,
  module,
  previous,
  ...
  if (!pack || pack.kind !== "list-tuple-practice") return null;
  ...
  return (
    <article className="published-lesson list-tuple-practice-development-pack">
      ...
      <div className="published-lesson-layout">
        <div className="published-lesson-flow">
          ...
          <section id="questions-list" className="lesson-card solved-questions-section">
            ...
            <p>
              Filter questions by difficulty below. Expand any question to view its scenario, hint, Python solution, step-by-step dry run, expected output, explanation, common pitfalls, and challenge extension.
            </p>
