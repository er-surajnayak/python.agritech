...
export interface OopAbstractionDevelopmentPack {
  kind: "oop-lesson-5-7";
  prerequisite: string;
  storyHook: string;
  smartFarmProblem: LessonTextSection & { incompleteClass: string; requirements: string[] };
  analogy: LessonTextSection & { requiredFields: string[] };
  definition: LessonTextSection & { visibleInterface: string[]; hiddenDetails: string[] };
  encapsulationComparison: Array<{ feature: string; encapsulation: string; abstraction: string }>;
  abstractClass: { title: string; body: string; code: string; rules: string[] };
  contract: { title: string; body: string; method: string; explanation: string };
  instantiationError: { title: string; code: string; error: string; explanation: string };
  concreteClass: { title: string; body: string; code: string; output: string };
  completeExample: { title: string; body: string; code: string; output: string };
  continuity: { polymorphism: string; abstraction: string };
  commonFunctionality: { title: string; body: string; code: string; output: string };
  machineExample: { title: string; body: string; contract: string[]; implementations: string[]; code: string };
  sensors: Array<{ className: string; output: string; implemented: boolean }>;
  debugChallenges: DebugChallengeContent[];
  engineerThinkingPrompt: string;
}

export interface OopMagicMethodsDevelopmentPack {
  kind: "oop-lesson-5-8";
  prerequisite: string;
  storyHook: string;
  objectProblem: { title: string; body: string; code: string; defaultOutput: string; desiredOutput: string };
  definition: LessonTextSection & { wordParts: Array<{ part: string; meaning: string }>; examples: string[] };
  automaticInvocation: { title: string; body: string; steps: WorkflowStep[] };
  methods: Array<{
    id: "init" | "str" | "len" | "eq" | "lt";
    name: string;
    operation: string;
    title: string;
    body: string;
  ...
  referenceMethods: Array<{ operation: string; method: string; purpose: string }>;
  completeExample: { title: string; body: string; code: string; output: string };
  agritechComparison: Array<{ utility: string; natural: string; benefit: string }>;
  debugChallenges: DebugChallengeContent[];
  engineerThinkingPrompt: string;
}

export interface NumpyIntroductionDevelopmentPack {
  kind: "numpy-introduction";
  prerequisite: string;
  storyHook: string;
  definition: LessonTextSection & { expansion: string; applications: string[] };
  vectorization: {
    title: string;
    body: string;
    listCode: string;
  ...
  comparison: Array<{ feature: string; pythonList: string; numpyArray: string }>;
  sensorExamples: Array<{ label: string; values: number[]; unit: string }>;
  dimensions: Array<{ dimension: "1D" | "2D" | "3D"; title: string; description: string; code: string }>;
  creationFunctions: Array<{ name: string; code: string; output: string; purpose: string }>;
  spacingComparison: Array<{ name: "arange" | "linspace"; mentalModel: string; code: string; output: string }>;
  dataTypes: Array<{ name: string; example: string; description: string }>;
  attributeExample: {
    code: string;
    values: number[][];
    attributes: Array<{ name: "ndim" | "shape" | "size" | "dtype"; value: string; meaning: string }>;
  };
  firstCalculation: { code: string; output: string; readings: number[] };
  mlPipeline: string[];
  practicePrompts: Array<{ title: string; prompt: string; code?: string }>;
}

export interface NumpyArrayCreationDevelopmentPack {
  kind: "numpy-array-creation";
  prerequisite: string;
  storyHook: string;
  fromData: { title: string; body: string; oneDimensionalCode: string; twoDimensionalCode: string; matrix: number[][] };
  initializedArrays: Array<{ id: "zeros" | "ones" | "full" | "empty"; name: string; purpose: string; oneDimensional: string; twoDimensional: string; output: string; warning?: string; useCase: string }>;
  sequenceFunctions: Array<{ id: "arange" | "linspace"; name: string; syntax: string; code: string; output: string; control: string; endpoint: string; agritechUse: string }>;
  identityMatrix: { title: string; body: string; code: string; values: number[][]; futureUses: string[] };
  randomFunctions: Array<{ id: "rand" | "randint" | "uniform" | "choice"; name: string; purpose: string; code: string; output: string; agritechUse: string }>;
  seed: { title: string; body: string; code: string; benefits: string[] };
  dtype: { title: string; body: string; examples: Array<{ code: string; output: string; note: string }> };
  cheatSheet: Array<{ name: string; purpose: string; example: string }>;
}

export interface NumpyArrayAttributesDevelopmentPack {
  kind: "numpy-array-attributes";
  prerequisite: string;
  storyHook: string;
  sensorDataset: { code: string; values: number[][]; columns: string[]; questions: string[] };
  attributes: Array<{
    id: "ndim" | "shape" | "size" | "dtype" | "itemsize" | "nbytes";
    name: string;
    question: string;
    value: string;
    meaning: string;
  ...
  dimensions: Array<{ id: "1D" | "2D" | "3D"; description: string; values: number[][][]; ndim: number; shape: string; size: number; farmMeaning: string }>;
  dataTypes: Array<{ name: string; meaning: string; example: string; focus?: boolean }>;
  conversion: { creationCode: string; creationOutput: string; existingCode: string; existingOutput: string; warning: string };
  memory: { formula: string; platformNote: string; example: string };
  reshapePreview: { code: string; fromShape: string; toShape: string; rule: string };
  quickReference: Array<{ name: string; purpose: string; kind: "attribute" | "method" | "preview" }>;
  debugChallenges: DebugChallengeContent[];
}

export interface NumpyIndexingDevelopmentPack {
  kind: "numpy-indexing-reshaping";
  prerequisite: string;
  storyHook: string;
  oneDimensional: { values: number[]; examples: Array<{ code: string; output: string; meaning: string }> };
  matrix: { name: string; values: number[][]; columns: string[]; examples: Array<{ code: string; output: string; meaning: string }> };
  slices: Array<{ code: string; output: string; meaning: string }>;
  modification: Array<{ code: string; before: string; after: string; meaning: string }>;
  booleanIndexing: { values: number[]; condition: string; mask: string; code: string; output: string; note: string };
  reshape: { values: number[]; validShapes: string[]; invalidShape: string; autoExamples: Array<{ code: string; shape: string }> };
  flattening: Array<{ name: "flatten" | "ravel"; code: string; output: string; behavior: string }>;
  transpose: { values: number[][]; code: string; output: string; fromShape: string; toShape: string };
  quickReference: Array<{ operation: string; example: string; purpose: string }>;
  debugChallenges: DebugChallengeContent[];
}

export interface NumpyOperationsDevelopmentPack {
  kind: "numpy-operations-broadcasting";
  prerequisite: string;
  storyHook: string;
  vectorization: { listCode: string; numpyCode: string; result: string; explanation: string };
  arithmetic: Array<{ id: "add" | "subtract" | "multiply" | "divide" | "power" | "modulo"; operator: string; left: number[]; right?: number[]; scalar?: number; output: string; meaning: string }>;
  celsius: { code: string; input: number[]; output: number[]; formula: string };
  comparisons: Array<{ code: string; output: string; meaning: string }>;
  booleanSum: { code: string; output: string; meaning: string };
  broadcasting: { matrix: number[][]; rowOffset: number[]; rowResult: number[][]; columnMatrix: number[][]; columnOffset: number[][]; columnResult: number[][] };
  rules: { statements: string[]; compatible: Array<{ left: string; right: string; result: string }>; incompatible: Array<{ left: string; right: string; reason: string }> };
  calibration: { matrix: number[][]; offset: number[]; result: number[][]; columns: string[] };
  operatorReference: Array<{ operator: string; meaning: string; example: string }>;
  comparisonReference: Array<{ operator: string; meaning: string }>;
  multiplyComparison: { elementWise: string; elementOutput: string; matrix: string; matrixOutput: string; explanation: string };
  quickReference: Array<{ concept: string; example: string }>;
  debugChallenges: DebugChallengeContent[];
}

export interface NumpyMathStatisticsDevelopmentPack {
  kind: "numpy-math-statistics";
  prerequisite: string;
  storyHook: string;
  moisture: { values: number[]; sorted: number[]; range: number; statistics: Array<{ id: "sum" | "mean" | "median" | "min" | "max" | "var" | "std" | "argmin" | "argmax"; label: string; code: string; result: string; meaning: string }> };
  extremes: { values: number[]; minimum: { value: number; index: number }; maximum: { value: number; index: number } };
  spread: { variance: string; standardDeviation: string; explanation: string };
  mathematical: Array<{ id: "sqrt" | "abs" | "round" | "power" | "exp" | "log" | "sin" | "cos"; code: string; input: string; output: string; meaning: string; focus?: boolean }>;
  axis: { matrix: number[][]; columns: string[]; functions: Array<{ id: "mean" | "sum" | "min" | "max" | "std"; label: string }>; results: Record<"mean" | "sum" | "min" | "max" | "std", { axis0: number[]; axis1: number[] }> };
  methodEquivalents: Array<{ function: string; method: string; purpose: string }>;
  quickReference: Array<{ category: "Statistical" | "Mathematical"; name: string; purpose: string }>;
  debugChallenges: DebugChallengeContent[];
}

export interface NumpyFilteringDevelopmentPack {
  kind: "numpy-sorting-searching-filtering";
  prerequisite: string;
  storyHook: string;
  sorting: { values: number[]; ascending: number[]; descending: number[]; indices: number[]; copyCode: string; inPlaceCode: string };
  where: { values: number[]; condition: string; mask: boolean[]; indices: number[]; filtered: number[]; replacementCode: string; replacement: number[] };
  conditions: Array<{ id: "and" | "or"; code: string; values: number[]; mask: boolean[]; result: number[]; meaning: string }>;
  anyAll: Array<{ function: "np.any" | "np.all"; code: string; result: boolean; meaning: string }>;
  irrigation: { values: number[]; condition: string; mask: boolean[]; filtered: number[]; indices: number[] };
  sensorFilter: { matrix: number[][]; columns: string[]; filters: Array<{ id: "temperature" | "moisture" | "and" | "or"; label: string; code: string; mask: boolean[]; rows: number[][] }> };
  quickReference: Array<{ name: string; purpose: string; example: string }>;
  debugChallenges: DebugChallengeContent[];
}

export interface NumpyArrayManagementDevelopmentPack {
  ...
  combining: {
    ...
    second: number[];
    operations: Array<{
      id: "concatenate" | "vstack" | "hstack" | "stack" | "stack-axis-1";
      label: string;
      code: string;
      result: number[][];
      shape: string;
  ...
  twoDimensional: { farmA: number[][]; farmB: number[][]; axis0: number[][]; axis1: number[][] };
  splitter: { evenValues: number[]; unevenValues: number[] };
  columnStack: { temperature: number[]; humidity: number[]; moisture: number[]; result: number[][] };
  copyView: { original: number[]; sliceStart: number; sliceStop: number; modifiedValue: number; viewOriginal: number[]; viewSelection: number[]; copyOriginal: number[]; copySelection: number[] };
  quickReference: Array<{ name: string; purpose: string; example: string }>;
  debugChallenges: DebugChallengeContent[];
}

export interface NumpyDataAnalysisDevelopmentPack {
  kind: "numpy-data-analysis-capstone";
  prerequisite: string;
  storyHook: string;
  dataset: { values: number[][]; columns: string[]; shape: string; ndim: number; size: number };
  analyses: Array<{ id: "average" | "highest" | "lowest" | "irrigation" | "sort" | "top3"; label: string; code: string; explanation: string }>;
  filterColumns: Array<{ id: "temperature" | "humidity" | "moisture" | "yield"; label: string; index: number }>;
  normalization: { code: string; input: number[]; output: number[]; explanation: string };
  derivedMetric: { name: string; code: string; output: number[]; bestField: number };
...
export interface PandasDataFrameDevelopmentPack {
  kind: "pandas-dataframes-loading";
  prerequisite: string;
  storyHook: string;
  dataset: { columns: string[]; rows: number[][] };
  creation: Array<{ id: "dictionary" | "lists" | "numpy"; label: string; code: string; explanation: string }>;
  explorer: Array<{ id: "head" | "tail" | "sample" | "info" | "describe" | "columns" | "shape" | "select"; label: string; code: string; explanation: string }>;
  properties: Array<{ name: string; result: string; purpose: string }>;
  columnOperations: Array<{ title: string; code: string; result: string; note: string }>;
  fileOperations: Array<{ title: string; code: string; purpose: string }>;
  quickReference: Array<{ task: string; code: string }>;
  debugChallenges: DebugChallengeContent[];
}

export interface PandasSelectionDevelopmentPack {
  kind: "pandas-selection-filtering";
  prerequisite: string;
  storyHook: string;
  dataset: { columns: string[]; rows: number[][] };
  selectionExamples: Array<{ id: "columns" | "loc-row" | "loc-range" | "loc-grid" | "iloc-row" | "iloc-grid"; label: string; code: string; explanation: string }>;
  filterColumns: Array<{ id: "Temperature" | "Humidity" | "Soil_Moisture" | "Yield"; label: string }>;
  operators: Array<">" | ">=" | "<" | "<=" | "==">;
  queryExamples: Array<{ title: string; code: string; result: string; explanation: string }>;
  quickReference: Array<{ task: string; code: string }>;
  debugChallenges: DebugChallengeContent[];
}

export interface PandasCleaningDevelopmentPack {
  kind: "pandas-cleaning-missing-data";
  prerequisite: string;
  storyHook: string;
  dataset: { columns: string[]; rows: Array<Array<number | string | null>> };
  operations: Array<{ id: "detect" | "count" | "drop" | "mean" | "median" | "ffill" | "bfill" | "duplicates" | "dedupe" | "text"; label: string; code: string; explanation: string }>;
  workflow: string[];
  decisions: Array<{ question: string; options: string[]; correctIndex: number; explanation: string }>;
  typeExamples: Array<{ title: string; code: string; result: string; explanation: string }>;
  quickReference: Array<{ task: string; code: string }>;
  debugChallenges: DebugChallengeContent[];
}

export interface PandasTransformationDevelopmentPack {
  kind: "pandas-transformation-feature-engineering";
  prerequisite: string;
  storyHook: string;
  dataset: { columns: string[]; rows: Array<Array<number | string>> };
  operations: Array<{ id: "fahrenheit" | "ratio" | "gap" | "irrigation" | "moisture-status" | "yield-category" | "risk-score" | "risk-level"; label: string; column: string; code: string; explanation: string }>;
  methodExamples: Array<{ title: string; method: string; code: string; result: string; explanation: string }>;
  pipeline: string[];
  quickReference: Array<{ task: string; code: string }>;
  debugChallenges: DebugChallengeContent[];
}

export interface PandasGroupByDevelopmentPack {
  kind: "pandas-groupby-aggregation";
  prerequisite: string;
  storyHook: string;
  dataset: { columns: string[]; rows: Array<Array<number | string>> };
  groupColumns: Array<"Crop" | "Region">;
  metricColumns: Array<"Yield" | "Temperature" | "Soil_Moisture" | "Field_ID">;
  aggregations: Array<{ id: "mean" | "sum" | "min" | "max" | "median" | "count" | "std"; label: string; explanation: string }>;
  aggOptions: Array<{ column: "Yield" | "Soil_Moisture" | "Temperature"; functions: Array<"mean" | "min" | "max"> }>;
  quickReference: Array<{ task: string; code: string }>;
  debugChallenges: DebugChallengeContent[];
}

export interface PandasCombiningReshapingDevelopmentPack {
  kind: "pandas-combining-reshaping";
  prerequisite: string;
  storyHook: string;
  fields: { columns: string[]; rows: Array<Array<number | string>> };
  sensor: { columns: string[]; rows: Array<Array<number | string>> };
  yieldData: { columns: string[]; rows: Array<Array<number | string>> };
  monthlyLong: { columns: string[]; rows: Array<Array<number | string>> };
  monthlyWide: { columns: string[]; rows: Array<Array<number | string>> };
  decisions: Array<{ question: string; answer: "concat" | "merge" | "join" | "pivot" | "pivot_table" | "melt"; explanation: string }>;
  quickReference: Array<{ task: string; code: string }>;
  debugChallenges: DebugChallengeContent[];
}

export interface MatplotlibBasicsDevelopmentPack {
  kind: "matplotlib-introduction-basics";
  prerequisite: string;
  storyHook: string;
  dataset: {
    days: number[];
    variables: Array<{ id: "temperature" | "moisture" | "rainfall"; label: string; values: number[]; unit: string; chartTitle: string }>;
  };
  markers: Array<{ value: "o" | "s" | "^"; label: string }>;
  lineStyles: Array<{ value: "-" | "--" | ":"; label: string }>;
  workflow: string[];
  commonMistakes: Array<{ title: string; code: string; explanation: string }>;
  quickReference: Array<{ task: string; code: string }>;
  debugChallenges: DebugChallengeContent[];
}

export interface MatplotlibChartTypesDevelopmentPack {
  kind: "matplotlib-core-chart-types";
  prerequisite: string;
  storyHook: string;
  timeSeries: {
    days: number[];
    variables: Array<{ id: "temperature" | "moisture" | "rainfall"; label: string; values: number[]; unit: string }>;
    yieldValues: number[];
  };
  cropYield: { crops: string[]; values: number[]; unit: string };
  decisions: Array<{ question: string; answer: "line" | "bar" | "scatter" | "area"; explanation: string }>;
  commonMistakes: Array<{ title: string; code: string; explanation: string }>;
  quickReference: Array<{ task: string; code: string; use: string }>;
  debugChallenges: DebugChallengeContent[];
}

export interface MatplotlibDistributionDevelopmentPack {
  kind: "matplotlib-distribution-analysis";
  prerequisite: string;
  storyHook: string;
  datasets: Array<{ id: "temperature" | "moisture" | "rainfall" | "humidity"; label: string; values: number[]; unit: string; interpretation: string }>;
  fieldGroups: Array<{ label: string; values: number[] }>;
  outlierData: number[];
  commonMistakes: Array<{ title: string; code: string; explanation: string }>;
  quickReference: Array<{ task: string; code: string; meaning: string }>;
  debugChallenges: DebugChallengeContent[];
}

export interface MatplotlibCustomizationDevelopmentPack {
  kind: "matplotlib-customization-subplots";
  prerequisite: string;
  storyHook: string;
  data: {
    days: number[];
    variables: Array<{ id: "temperature" | "moisture" | "rainfall" | "yield"; label: string; values: number[]; unit: string; chart: "line" | "bar" }>;
  };
  markers: Array<{ value: "o" | "s" | "^" | "x" | "*"; label: string }>;
  lineStyles: Array<{ value: "-" | "--" | ":" | "-."; label: string }>;
